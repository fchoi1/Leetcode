<h2><a href="https://leetcode.com/problems/univalued-binary-tree/solutions/">965. Univalued Binary Tree</a></h2><h3>Easy</h3><hr><p>A binary tree is <strong>uni-valued</strong> if every node in the tree has the same value.</p>
