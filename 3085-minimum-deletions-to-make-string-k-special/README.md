<h2><a href="https://leetcode.com/problems/minimum-deletions-to-make-string-k-special/solutions/">3085. Minimum Deletions to Make String K-Special</a></h2><h3>Medium</h3><hr><p>You are given a string <code>word</code> and an integer <code>k</code>.</p>
